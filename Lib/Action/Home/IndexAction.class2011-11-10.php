...
class IndexAction extends LoginCommonAction
{
	...
	function CollectionNameDelete()
	{
		if ($this->checkRole())
		{
			...
			/*
			         ...
			         $sqlDeleteRelations = "delete from THINK_TBCODECOLLECTION where COLLECTIONID = '$cid'";
	...
	function CollectionNameUpdate()
	{
		if ($this->checkRole())
		{
			...
			{
				$this->assign('jumpUrl',"/Admin/Index/CollectionNameEdit/$cid");
